...
public class TestConfig implements CommandLineRunner {  //Classe seeding do repository
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2009-05-23T16:50:30Z"), u2);
		Order o2 = new Order(null,Instant.parse("2009-04-10T18:20:20Z"),u2);
		Order o3 = new Order(null,Instant.parse("2011-02-12T21:30:00Z"),u1);
